...
urlpatterns = [
    ...
    path('infantil', views.ListaProdutosI.as_view(), name="listaI"),
    path('acessorios', views.ListaProdutosA.as_view(), name="listaA"),
    ...
    path('solicit/', views.solicitacao, name='solicitacao'),
]
